...
var removeSelectedItemFromCart = document.querySelectorAll('.remove-selected-item-from-cart');
var cardCounter = document.querySelector('#cardCounter');
var mode;

function updateCart(burger, mode) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/update-cart', {
    burger: burger,
    mode: mode
  }).then(function (res) {
    cardCounter.innerText = res.data.totalQty;

    if (document.getElementById(res.data.id) != null && document.getElementById('price' + res.data.id) != null) {
      document.getElementById(res.data.id).innerHTML = res.data.qty;
      document.getElementById('price' + res.data.id).innerHTML = res.data.price;
      document.getElementById('totalPrice').innerHTML = res.data.totalPrice;
    }

    if (res.data.msg != null) {
      document.getElementById('item' + res.data.id).parentNode.removeChild(document.getElementById('item' + res.data.id));
    }
...
removeSelectedItemFromCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var burger = JSON.parse(btn.dataset.burger);
    mode = btn.dataset.id;
    updateCart(burger, mode);
...
lozad__WEBPACK_IMPORTED_MODULE_2___default()('.lozad', {
...
var dropdownToggle = document.querySelector('#toggle');
...
__webpack_require__(/*! C:\Users\Raheem\Desktop\Realtime-Burger\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Raheem\Desktop\Realtime-Burger\resources\scss\app.scss */"./resources/scss/app.scss");
